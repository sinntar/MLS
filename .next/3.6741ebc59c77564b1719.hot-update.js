...
var _default = function _default() {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_semantic_ui_react__["d" /* Menu */].Item, { name: "MLS - BlockChain", __source: {
          fileName: _jsxFileName,
          lineNumber: 9
        }
      }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_semantic_ui_react__["d" /* Menu */].Item, { active: true, name: "home", route: "/", __source: {
          fileName: _jsxFileName,
          lineNumber: 10
        }
      }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1_semantic_ui_react__["d" /* Menu */].Item, { name: "logout", __source: {
            fileName: _jsxFileName,
            lineNumber: 12
          }
        })
...
var REServiceIndex = function (_Component) {
  ...
  _createClass(REServiceIndex, [{
    ...
    value: function renderREServices() {
      var items = this.props.reServices.map(function (address) {
        return {
          header: address.name,
          meta: "Address: " + address.contract,
          description: __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
            __WEBPACK_IMPORTED_MODULE_5__routes__["Link"],
            {
              route: "/reService/" + address.contract + "/listings/listingsSummary",
              __source: {
                fileName: _jsxFileName,
                lineNumber: 25
              }
            ...
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                for (i = 0; i < reServices.length; i++) {
                  obj.push({ contract: reServices[i], name: "Contract " + i });
                }
                console.log(obj);
...
//# sourceMappingURL=3.6741ebc59c77564b1719.hot-update.js.map