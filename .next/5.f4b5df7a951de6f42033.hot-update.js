...
var ListingImageSummary = function (_Component) {
  ...
  _createClass(ListingImageSummary, [{
    ...
    value: function renderMediaCards() {
      return this.props.list.map(function (list) {
        return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_semantic_ui_react__["b" /* Card */], { image: "https://gateway.ipfs.io/ipfs/${list.mediaURL}", __source: {
            fileName: _jsxFileName,
            lineNumber: 196
          }
        });
...
//# sourceMappingURL=5.f4b5df7a951de6f42033.hot-update.js.map